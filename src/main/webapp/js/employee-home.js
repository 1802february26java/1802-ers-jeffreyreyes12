window.onload = () => {
  ...
  document.getElementById('lastName').innerHTML = sessionStorage.getItem("employeeLastName");
  document.getElementById('firstName').innerHTML = sessionStorage.getItem("employeeFirstName");
